...
@section('subtitle', 'Ingresa tus datos para el registro.')
               ...
               @csrf
                ...
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input id="password_confirmation" class="form-control" placeholder="Confirmar Contraseña" type="password" name="password_confirmation" required>
                  </div>
                </div>
